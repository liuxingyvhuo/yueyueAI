...
# 科大讯飞相关配置
APPID = '72cc3df2'
APISecret = 'MmZiMjBlMjEyMjczNmY0MzVlYTliYzU1'
APIKey = '8a391f073e0e142ca1c8b24e4dded644'
QF_AUTHORIZATION = "Bearer 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"  # 请填写您的Authorization
...
class Ws_Param(object):
    ...
    def __init__(self, APPID, APIKey, APISecret, Text):
        ...
        self.BusinessArgs = {"aue": "raw", "auf": "audio/L16;rate=16000", "vcn": "xiaoyan",
                             "speed": 30, "volume": 30, "pitch": 55, "tte": "utf8"}
...
def recognize_audio(wav_path):
    ...
    model = whisper.load_model("turbo")  # 你可以选择 "base", "small", "medium", "large" 等模型
    ...
    while True:
        ...
        try:
            ...
            if end_signal_received.is_set():
                ...
                combined_audio_path = os.path.join(UPLOAD_FOLDER, "combined_audio.mp3")
                ...
                # 调用 whisper 语音识别模型
                recognized_text = recognize_audio(combined_audio_path)
                if recognized_text:
                    # 打印识别出的文字
                    print(f"Recognized Text: {recognized_text}")
                    # 启动一个新的线程来调用大模型API
                    ...
                    if response_content:
                        # 发送回复内容给客户端
                        client_ip = "192.168.27.129"  # 客户端IP地址
